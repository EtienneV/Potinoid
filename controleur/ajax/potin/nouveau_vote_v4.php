...
echo '<div class="potin-vote-wrapper-v4">';
...
if(deja_vote($_POST['id_Potin'], $_POST['auteur'], $bdd)) // si on a déjà voté
{
	...
	echo '" typeBouton="vrai" idUser="'.$_POST['auteur'].'" idPotin="'.$_POST['id_Potin'].'" typePotin="v4">C\'est vrai</span>';

	echo '<span class="potin-bouton Bnesaitpas';
	if ($vote_user == 0) echo '-active';
	echo '" typeBouton="nesaitpas" idUser="'.$_POST['auteur'].'" idPotin="'.$_POST['id_Potin'].'" typePotin="v4">Je ne sais pas</span>';

	echo '<span class="potin-bouton Bfaux';
	if ($vote_user == -1) echo '-active';
	echo '" typeBouton="faux" idUser="'.$_POST['auteur'].'" idPotin="'.$_POST['id_Potin'].'" typePotin="v4">C\'est faux</span>';
...
{ 
	echo '<div class="boutons-vote-wrapper">';
	echo '<span class="potin-bouton Bvrai" typeBouton="vrai" idUser="'.$_POST['auteur'].'" idPotin="'.$_POST['id_Potin'].'" typePotin="v4">C\'est vrai</span>';
	echo '<span class="potin-bouton Bnesaitpas" typeBouton="nesaitpas" idUser="'.$_POST['auteur'].'" idPotin="'.$_POST['id_Potin'].'" typePotin="v4">Je ne sais pas</span>';
	echo '<span class="potin-bouton Bfaux" typeBouton="faux" idUser="'.$_POST['auteur'].'" idPotin="'.$_POST['id_Potin'].'" typePotin="v4">C\'est faux</span>';
	echo '</div>';
}
